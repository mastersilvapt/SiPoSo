-module(client).
-export([sum/4,sub/4,mult/4,fact/3,is_prime/3, fib/3, maclaurinSeries/4,list/0]).
...
maclaurinSeries(End,X,T,Server) -> io:format("The result is ~p~n",[rpc(Server,T,{macSeries,{End,X}})]).
